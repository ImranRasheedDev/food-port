        ...
        <LayoutWrapper>
            <div className='flex flex-col md:flex-row rounded-sm md:rounded-3xl'>
                <div className='w-full md:w-3/5'>
                    <img src={processImageUrl("/images/cta.png")} alt="" className='block h-[500px] w-full object-cover rounded-tl-sm md:rounded-tl-3xl rounded-bl-sm md:rounded-bl-3xl' />
                </div>
