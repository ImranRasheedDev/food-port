        ...
        <div className="bg-primary-995 p-10 rounded-lg border border-primary-1006">
            ...
            <div>
                <div className="flex gap-x-2 border-b border-primary-1007 py-8">
                    ...
                    <div>
                        <p className="font-bold text-xl">13th Street 47 W 13th St, New York, NY 10011, USA</p>
                        <p className="text-primary-1013"> New York</p>
                    </div>
                </div>
                <div className="flex gap-x-2 justify-between pt-8 pb-8">
                    ...
                    <div className="flex items-center gap-x-2 ">
                        ...
                        <span className="text-primary-1016">
                            45 minutes
                        </span>
                    </div>
                </div>
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-x-2 justify-between">
                        <a href="callto:+1234567890" className="text-primary-100">Call</a>
                        <a href="callto:+1234567890" className="text-primary-100"><Phone className="w-5 h-5" /></a>
                    </div>
                    <div className="flex items-center gap-x-2 justify-between">
                        <a href="https://wa.me/923001234567" target="_blank" className="text-primary-100">WhatsApp</a>
                        <a href="https://wa.me/923001234567" target="_blank" className="text-primary-100">
                            <svg
