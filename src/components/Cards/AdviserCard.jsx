...
const AdviserCard = ({ title, companyName, description, link, index }) => {
    const isOdd = index % 2 === 0;

    const bgClass = isOdd ? "bg-primary-1003" : "bg-primary-1004";
    const btnTextClass = isOdd ? "text-primary-50" : "text-primary-1004";
    return (
        <div className={`${bgClass} flex gap-x-10 text-white rounded-4xl items-center`}>
            ...
            <div className='ml-auto ronded-tr-4xl rounded-br-4xl w-2/5 flex justify-end'>
                <img src="/images/advertise.png" alt="" className='ronded-tr-4xl rounded-br-4xl block' />
            </div>
        </div>
    )
}
