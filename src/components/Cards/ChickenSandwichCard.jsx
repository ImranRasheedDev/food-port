...
const ChickenSandwichCard = () => {
    return (
        <div className='flex flex-col md:flex-row rounded-sm md:rounded-3xl h-full md:h-[400px]'>
            <div className='w-full md:w-2/3'>
                <img src="/images/daily-deals-image.jpg" alt="Chicken Sandwiches" className='block h-full md:h-[400px] w-full object-cover rounded-tl-sm md:rounded-tl-3xl rounded-bl-sm md:rounded-bl-3xl md:rounded-tr-none md:rounded-br-none' />
            </div>
