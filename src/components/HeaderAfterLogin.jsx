...
import { ChevronDown, ShoppingCart, Menu, X, MapPin, Globe, Heart, User, LayoutDashboard, Megaphone, FileCheck2 } from "lucide-react";
                    ...
                    <div className="flex items-center space-x-4">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className={"w-3xs shadow-lg p-0"}>
                                <DropdownMenuItem className={"p-0 bg-white hover:bg-primary-990"}>
                                    <Link to={""} className="flex items-center gap-x-2 w-full p-5">
                                ...
                                <DropdownMenuItem className={"p-0 bg-white hover:bg-primary-990"}>
                                    <button to={""} className="flex items-center gap-x-2 w-full p-5 cursor-pointer">
                                        <FileCheck2 /> Logout
                                    </button>
                                </DropdownMenuItem>
                            </DropdownMenuContent>
